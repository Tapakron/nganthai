...
<head>
    ...
    <link rel="stylesheet" class="skin" type="text/css" href="{{ asset('assets/css/skins-type/skin-4.css') }}">
                    ...
                    <div class="twm-home3-inner-section">
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 twm-hpage-12-v-bnr-right-content">
                                <div class="twm-hpage-13-v-bnr" style="background-image:url({{ asset('assets/images/home-13/banner-bg/right-pic1.jpg') }})">
                                                ...
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="{{ asset('assets/images/home-6/featured-jobs/google.png') }}" alt="#">
                                                            </div>
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list odd">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="{{ asset('assets/images/home-6/featured-jobs/behance.png') }}" alt="#">
                                                            </div>
                                                            <div class="v-jobs-list-info">
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="{{ asset('assets/images/home-6/featured-jobs/facebook.png') }}" alt="#">
                                                            </div>
                                                            <div class="v-jobs-list-info">
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list odd">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="{{ asset('assets/images/home-6/featured-jobs/instagram.png') }}" alt="#">
                                                            </div>
                                                            <div class="v-jobs-list-info">
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="{{ asset('assets/images/home-6/featured-jobs/pinterest.png') }}" alt="#">
                                                            </div>
                                                            <div class="v-jobs-list-info">
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list odd">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="{{ asset('assets/images/home-6/featured-jobs/yahoo.png') }}" alt="#">
                                                            </div>
                                                            <div class="v-jobs-list-info">
                                                                <h3 class="twm-title">Product Manager</h3>
                                                                <p>Yahoo!</p>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-12">
                                <div class="twm-featured-city twm-large-block">
                                    <div class="twm-media">
                                        <img src="{{ asset('assets/images/featured-cities/city1.jpg') }}" alt="">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="twm-featured-city">
                                            <div class="twm-media">
                                                <img src="{{ asset('assets/images/featured-cities/city2.jpg') }}" alt="">
                                                <div class="twm-city-info">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="twm-featured-city">
                                            <div class="twm-media">
                                                <img src="{{ asset('assets/images/featured-cities/city3.jpg') }}" alt="">
                                                <div class="twm-city-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-7 col-lg-12 col-md-12">
                                    <div class="twm-explore-right-section">
                                        <div class="twm-media">
                                            <div class="twm-bg-circle"><img src="{{ asset('assets/images/home-4/bg-circle.png') }}" alt="">
                                            </div>
                                            <div class="twm-employee-pic"><img src="{{ asset('assets/images/home-4/employee.png') }}" alt="">
                                            </div>
                                            <div class="twm-shot-pic1  anm" data-speed-x="-4" data-speed-scale="-25">
                                                <img src="{{ asset('assets/images/home-4/sq-1.png') }}" alt="">
                                            </div>
                                            <div class="twm-shot-pic2 anm" data-wow-delay="1000ms" data-speed-x="2" data-speed-y="2"><img src="{{ asset('assets/images/home-4/triangle.png') }}" alt=""></div>
                                            <div class="twm-shot-pic3  anm" data-speed-x="-4" data-speed-scale="-25"><img src="{{ asset('assets/images/home-4/circle.png') }}" alt="">
                                            </div>
                                        </div>
                        ...
                        <div class="twm-blog-post-h5-wrap">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="blog-post twm-blog-post-h5-outer">
                                        <div class="wt-post-media">
                                            <a href="blog-single.html"><img src="{{ asset('assets/images/home-5/blog/pic1.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="wt-post-info">
                                            <div class="post-author">
                                                <div class="post-author-pic">
                                                    <div class="p-a-pic"><img src="{{ asset('assets/images/home-5/blog-avtar/pic1.jpg') }}" alt=""></div>
                                                    <div class="p-a-info">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="blog-post twm-blog-post-h5-outer">
                                        <div class="wt-post-media">
                                            <a href="blog-single.html"><img src="{{ asset('assets/images/home-5/blog/pic2.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="wt-post-info">
                                            <div class="post-author">
                                                <div class="post-author-pic">
                                                    <div class="p-a-pic"><img src="{{ asset('assets/images/home-5/blog-avtar/pic2.jpg') }}" alt=""></div>
                                                    <div class="p-a-info">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="blog-post twm-blog-post-h5-outer">
                                        <div class="wt-post-media">
                                            <a href="blog-single.html"><img src="{{ asset('assets/images/home-5/blog/pic3.jpg') }}" alt=""></a>
                                        </div>
                                        <div class="wt-post-info">
                                            <div class="post-author">
                                                <div class="post-author-pic">
                                                    <div class="p-a-pic"><img src="{{ asset('assets/images/home-5/blog-avtar/pic3.jpg') }}" alt=""></div>
                                                    <div class="p-a-info">
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <div class="widget widget_about">
                                <div class="logo-footer clearfix">
                                    <a href="index.html"><img src="{{ asset('assets/images/logo-13.png') }}" alt=""></a>
                                </div>
