...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/magnific-popup.min.css')); ?>">
    <!-- MAGNIFIC POPUP STYLE SHEET -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/lc_lightbox.css')); ?>">
    <!-- Lc light box popup -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/bootstrap-select.min.css')); ?>">
    <!-- BOOTSTRAP SLECT BOX STYLE SHEET  -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/dataTables.bootstrap5.min.css')); ?>">
    <!-- DATA table STYLE SHEET  -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/select.bootstrap5.min.css')); ?>">
    <!-- DASHBOARD select bootstrap  STYLE SHEET  -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/dropzone.css')); ?>">
    <!-- DROPZONE STYLE SHEET -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/scrollbar.css')); ?>">
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/flaticon.css')); ?>"> <!-- Flaticon -->
    ...
    <link rel="stylesheet" class="skin" type="text/css" href="<?php echo e(asset('assets/css/skins-type/skin-4.css')); ?>">
...
<body data-anm=".anm">
                    ...
                    <div class="container-fluid clearfix">
                        ...
                        <div class="logo-header">
                            <div class="logo-header-inner logo-header-one">
                                <a href="index.html">
                                    <img src="<?php echo e(asset('assets/images/logo-13.png')); ?>" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-6 col-md-12 twm-hpage-12-v-bnr-left-content">
                                <div class="twm-bnr-mid-section">
                                    ...
                                    <div class="twm-bnr-discription">Type your keyword, then click search to find your
                                        perfect job.</div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12 twm-hpage-12-v-bnr-right-content">
                                <div class="twm-hpage-13-v-bnr" style="background-image:url(<?php echo e(asset('assets/images/home-13/banner-bg/right-pic1.jpg')); ?>)">
                                                ...
                                                <div class="swiper-wrapper">
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="<?php echo e(asset('assets/images/home-6/featured-jobs/google.png')); ?>" alt="#">
                                                            </div>
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list odd">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="<?php echo e(asset('assets/images/home-6/featured-jobs/behance.png')); ?>" alt="#">
                                                            </div>
                                                            <div class="v-jobs-list-info">
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="<?php echo e(asset('assets/images/home-6/featured-jobs/facebook.png')); ?>" alt="#">
                                                            </div>
                                                            <div class="v-jobs-list-info">
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list odd">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="<?php echo e(asset('assets/images/home-6/featured-jobs/instagram.png')); ?>" alt="#">
                                                            </div>
                                                            <div class="v-jobs-list-info">
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="<?php echo e(asset('assets/images/home-6/featured-jobs/pinterest.png')); ?>" alt="#">
                                                            </div>
                                                            <div class="v-jobs-list-info">
                                                    ...
                                                    <div class="swiper-slide">
                                                        ...
                                                        <div class="v-jobs-list odd">
                                                            <div class="v-jobs-list-icon">
                                                                <img src="<?php echo e(asset('assets/images/home-6/featured-jobs/yahoo.png')); ?>" alt="#">
                                                            </div>
                                                            <div class="v-jobs-list-info">
                                                                <h3 class="twm-title">Product Manager</h3>
                                                                <p>Yahoo!</p>
                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-12">
                                <div class="twm-featured-city twm-large-block">
                                    <div class="twm-media">
                                        <img src="<?php echo e(asset('assets/images/featured-cities/city1.jpg')); ?>" alt="">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="twm-featured-city">
                                            <div class="twm-media">
                                                <img src="<?php echo e(asset('assets/images/featured-cities/city2.jpg')); ?>" alt="">
                                                <div class="twm-city-info">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="twm-featured-city">
                                            <div class="twm-media">
                                                <img src="<?php echo e(asset('assets/images/featured-cities/city3.jpg')); ?>" alt="">
                                                <div class="twm-city-info">
                                ...
                                <div class="twm-w-process-steps3">
                                    <div class="twm-w-pro-top">
                                        ...
                                        <div class="twm-media bg-clr-sky">
                                            <span><img src="<?php echo e(asset('assets/images/work-process/icon1.png')); ?>" alt="icon1"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="twm-w-process-steps3">
                                    <div class="twm-w-pro-top">
                                        ...
                                        <div class="twm-media bg-clr-pink">
                                            <span><img src="<?php echo e(asset('assets/images/work-process/icon2.png')); ?>" alt="icon1"></span>
                                        </div>
                                    </div>
                                ...
                                <div class="twm-w-process-steps3">
                                    <div class="twm-w-pro-top">
                                        ...
                                        <div class="twm-media  bg-clr-green">
                                            <span><img src="<?php echo e(asset('assets/images/work-process/icon3.png')); ?>" alt="icon1"></span>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                    ...
                                    <div class="twm-explore-content-outer2">
                                        <div class="twm-explore-top-section">
                                            ...
                                            <div class="section-head left wt-small-separator-outer">
                                                ...
                                                <p>Get paid easily and security. Use our resources to become independent
                                                    and showcase your professional skills.</p>
                                ...
                                <div class="col-xl-7 col-lg-12 col-md-12">
                                    <div class="twm-explore-right-section">
                                        <div class="twm-media">
                                            <div class="twm-bg-circle"><img src="<?php echo e(asset('assets/images/home-4/bg-circle.png')); ?>" alt="">
                                            </div>
                                            <div class="twm-employee-pic"><img src="<?php echo e(asset('assets/images/home-4/employee.png')); ?>" alt="">
                                            </div>
                                            <div class="twm-shot-pic1  anm" data-speed-x="-4" data-speed-scale="-25">
                                                <img src="<?php echo e(asset('assets/images/home-4/sq-1.png')); ?>" alt="">
                                            </div>
                                            <div class="twm-shot-pic2 anm" data-wow-delay="1000ms" data-speed-x="2" data-speed-y="2"><img src="<?php echo e(asset('assets/images/home-4/triangle.png')); ?>" alt=""></div>
                                            <div class="twm-shot-pic3  anm" data-speed-x="-4" data-speed-scale="-25"><img src="<?php echo e(asset('assets/images/home-4/circle.png')); ?>" alt="">
                                            </div>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-grid-style1  m-b30">
                                        <div class="twm-media">
                                            <img src="<?php echo e(asset('assets/images/jobs-company/pic1.jpg')); ?>" alt="#">
                                        </div>
                                        ...
                                        <div class="twm-mid-content">
                                            ...
                                            <p class="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA
                                            </p>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-grid-style1 m-b30">
                                        <div class="twm-media">
                                            <img src="<?php echo e(asset('assets/images/jobs-company/pic2.jpg')); ?>" alt="#">
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-grid-style1  m-b30">
                                        <div class="twm-media">
                                            <img src="<?php echo e(asset('assets/images/jobs-company/pic3.jpg')); ?>" alt="#">
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-grid-style1 m-b30">
                                        <div class="twm-media">
                                            <img src="<?php echo e(asset('assets/images/jobs-company/pic4.jpg')); ?>" alt="#">
                                        </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="twm-jobs-grid-style1  m-b30">
                                        <div class="twm-media">
                                            <img src="<?php echo e(asset('assets/images/jobs-company/pic5.jpg')); ?>" alt="#">
                                        </div>
                                        <span class="twm-job-post-duration">1 days ago</span>
                        ...
                        <div class="twm-blog-post-h5-wrap">
                            <div class="row">
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="blog-post twm-blog-post-h5-outer">
                                        <div class="wt-post-media">
                                            <a href="blog-single.html"><img src="<?php echo e(asset('assets/images/home-5/blog/pic1.jpg')); ?>" alt=""></a>
                                        </div>
                                        <div class="wt-post-info">
                                            <div class="post-author">
                                                <div class="post-author-pic">
                                                    <div class="p-a-pic"><img src="<?php echo e(asset('assets/images/home-5/blog-avtar/pic1.jpg')); ?>" alt=""></div>
                                                    <div class="p-a-info">
                                            ...
                                            <div class="wt-post-title ">
                                                <h4 class="post-title">
                                                    <a href="blog-single.html">How to convince recruiters and get your
                                                        dream job</a>
                                                </h4>
                                            </div>
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="blog-post twm-blog-post-h5-outer">
                                        <div class="wt-post-media">
                                            <a href="blog-single.html"><img src="<?php echo e(asset('assets/images/home-5/blog/pic2.jpg')); ?>" alt=""></a>
                                        </div>
                                        <div class="wt-post-info">
                                            <div class="post-author">
                                                <div class="post-author-pic">
                                                    <div class="p-a-pic"><img src="<?php echo e(asset('assets/images/home-5/blog-avtar/pic2.jpg')); ?>" alt=""></div>
                                                    <div class="p-a-info">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    ...
                                    <div class="blog-post twm-blog-post-h5-outer">
                                        <div class="wt-post-media">
                                            <a href="blog-single.html"><img src="<?php echo e(asset('assets/images/home-5/blog/pic3.jpg')); ?>" alt=""></a>
                                        </div>
                                        <div class="wt-post-info">
                                            <div class="post-author">
                                                <div class="post-author-pic">
                                                    <div class="p-a-pic"><img src="<?php echo e(asset('assets/images/home-5/blog-avtar/pic3.jpg')); ?>" alt=""></div>
                                                    <div class="p-a-info">
                        ...
                        <div class="col-lg-3 col-md-12">
                            ...
                            <div class="widget widget_about">
                                <div class="logo-footer clearfix">
                                    <a href="index.html"><img src="<?php echo e(asset('assets/images/logo-13.png')); ?>" alt=""></a>
                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <div class=" form-check">
                                                        ...
                                                        <label class="form-check-label rem-forgot" for="Password3">Remember me <a href="javascript:;">Forgot
                                                                Password</a></label>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-group mb-3">
                                                    <div class=" form-check">
                                                        ...
                                                        <label class="form-check-label rem-forgot" for="Password4">Remember me <a href="javascript:;">Forgot
                                                                Password</a></label>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <!-- JAVASCRIPT  FILES ========================================= -->
    <script src="<?php echo e(asset('assets/js/jquery-3.6.0.min.js')); ?>"></script><!-- JQUERY.MIN JS -->
    ...
    <script src="<?php echo e(asset('assets/js/bootstrap-select.min.js')); ?>"></script><!-- Form js -->
    <script src="<?php echo e(asset('assets/js/dropzone.js')); ?>"></script><!-- IMAGE UPLOAD  -->
    <script src="<?php echo e(asset('assets/js/jquery.scrollbar.js')); ?>"></script><!-- scroller -->
    <script src="<?php echo e(asset('assets/js/bootstrap-datepicker.js')); ?>"></script><!-- scroller -->
    <script src="<?php echo e(asset('assets/js/jquery.dataTables.min.js')); ?>"></script><!-- Datatable -->
    <script src="<?php echo e(asset('assets/js/dataTables.bootstrap5.min.js')); ?>"></script><!-- Datatable -->
    <script src="<?php echo e(asset('assets/js/chart.js')); ?>"></script><!-- Chart -->
    <script src="<?php echo e(asset('assets/js/anm.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/js/bootstrap-slider.min.js')); ?>"></script><!-- Price range slider -->
...
<?php /**PATH C:\xampp\htdocs\nganthai\resources\views/index.blade.php ENDPATH**/ ?>